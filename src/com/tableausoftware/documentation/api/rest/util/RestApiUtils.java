...
public class RestApiUtils {
     ...
     */
    public void invokeAppendFileUpload(TableauCredentialsType credential, String siteId, String uploadSessionId,
        ...
        TsResponse tsResponse = putMultipart(url, credential.getToken(), null, filePart);
     ...
     *         <code>null</code>
     */
    public FileUploadType invokeInitiateFileUpload(TableauCredentialsType credential, String siteId) {
     ...
     * @return the response from the request
     */
    public TsResponse postMultipart(String url, String authToken, TsRequest requestPayload, BodyPart filePart) {
        // Creates an instance of StringWriter to hold the XML for the request
        StringWriter writer = new StringWriter();
     ...
     */
    public TsResponse unmarshalResponse(String responseXML) {
